...
export default function NewLocationScreen() {
  ...
  const { addLocation } = useFilmingLocations();
  ...
  const uploadImages = async (): Promise<string[]> => {
    ...
    for (const uri of images) {
      // Si l'URI commence par http et n'est pas un blob, c'est déjà une URL publique
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Succès', 'Votre lieu de tournage a été publié !', [
  ...
  return (
    <ScreenContainer style={[styles.container, { backgroundColor: colors.background }]}>
      <Stack.Screen options={{ title: 'Publier un lieu', headerTitle: 'Publier un lieu' }} />
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.form}>
          ...
          {/* ajoute un waring qui dit de demander au proprietaire des lieu avant de publier met la boite et le text en rouge*/}
          <View style={[styles.warningContainer, { backgroundColor: colors.card }]}>
            <Text style={[styles.warningText, { color: colors.danger }]}>
              Veuillez demander l'autorisation au propriétaire du lieu avant de publier.
            </Text>
          </View>
          <TouchableOpacity
          ...
          >
            ...
            {isLoading ? (
              ...
              <Text style={styles.submitButtonText}>Publier mon lieu</Text>
            )}
          </TouchableOpacity>
        </View>
      </ScrollView>
